...
public class ExporterComponentCustom
    implements ExporterService
{
    ...
    private static final QName ASPECT_IGNORE_EXPORT = QName.createQName("http://www.alfresco.com/model/alfresco-demo-data-export/1.0", "ignoreExport");
    ...
    private class DefaultCrawler implements ExporterCrawler
    {
        ...
        private void walkNode(NodeRef nodeRef, ExporterCrawlerParameters parameters, Exporter exporter, boolean exportAsRef)
        {
            ...
            //DEMO_DATA_CUSTOM
            if(aspects.contains(ASPECT_IGNORE_EXPORT)){
            	return;
            }
