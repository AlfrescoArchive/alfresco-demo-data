package org.alfresco.devops.patch;
...
public class SitePatch extends AbstractPatch
{
    private static final String MSG_SITE_PATCHED = "patch.sitePatch.success";
    private static final String MSG_SKIPPED = "patch.sitePatch.skipped";
    private static final String MSG_MISSING_SURFCONFIG = "patch.sitePatch.missingSurfConfig";
  ...
  public void setSiteName(String siteName)
    ...
    {
    	SiteInfo siteInfo = siteService.getSite(this.siteName);
    	if(siteInfo != null)
    	{
